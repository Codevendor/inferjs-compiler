 ...
 */
export function tagAbstract(parser, commentType, filePath, inferid, lineObject) {

    // Set Param Name
    //setValue(parser.source, ['methods', 'infers', inferid, lineObject.tag], true);
